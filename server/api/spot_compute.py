"""
AXON Protocol — Spot Compute Market
...
_ID = lambda prefix: f"axon_{prefix}_{uuid.uuid4().hex[:12]}"
    ...
    **Sellers**: Register your agent's idle capacity on the spot market.
    ...
    return {
        ...
        "data": {
            ...
            "status":           "active",
            "message":          "Your capacity is now live on the AXON spot market. Buyers can hire you immediately.",
        },
    }
