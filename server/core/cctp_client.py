"""
Circle CCTP v2 (Cross-Chain Transfer Protocol) client for OIXA Protocol.
...
Flow (as receiver on Base):
  ...
  4. We call receiveMessage on Base MessageTransmitter → USDC lands in OIXA wallet
...
logger = logging.getLogger("oixa.cctp")
...
BASE_DOMAIN = 6  # OIXA always receives on Base
